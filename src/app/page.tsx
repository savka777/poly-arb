...
const MOCK_MARKETS: Market[] = [
  ...
  { id: "sc-03", platform: "polymarket", question: "Will global average temperature breach 1.6°C above pre-industrial in 2026?", probability: 0.38, volume: 2_700_000, liquidity: 690_000, endDate: "2026-12-31", url: "#", category: "Science", lastUpdated: new Date().toISOString() },
  ...
  // CULTURE (12)
  { id: "cu-01", platform: "polymarket", question: "Will Beyoncé win the Grammy Album of the Year in 2026?", probability: 0.42, volume: 4_700_000, liquidity: 1_200_000, endDate: "2026-02-08", url: "#", category: "Culture", lastUpdated: new Date().toISOString() },
    ...
    <div className="px-4 py-3 border-b border-darwin-border last:border-b-0">
      ...
      <div className="flex items-center gap-3">
        <span className="text-[10px] text-darwin-text-secondary">
          Polyverse · {relativeTime(signal.createdAt)}
        </span>
        ...
        <section className="relative h-screen flex flex-col pointer-events-none">
          ...
          >
            ...
            >
              ...
              >
                Every active trade in the Polymarket universe — live pricing,
